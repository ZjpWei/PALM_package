...
palm_multi_rcpp <- function(null_obj, SUB_id, study_ID, feature_ID, Cov_int_info, Sample_info) {
    .Call('_PALM_palm_multi_rcpp', PACKAGE = 'PALM', null_obj, SUB_id, study_ID, feature_ID, Cov_int_info, Sample_info)
}
