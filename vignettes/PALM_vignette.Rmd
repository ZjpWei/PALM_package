...
The summary statistics correct for compositional effects by default using the median of the estimated values. Alternatively, you can set correct = "tune", which adjusts the compositional effect using a tuned value. This option often performs better when certain features dominate the average proportion or many significant features present.
